...
$config = [
  ...
  'account_mail_confirmed_reward' => [
    // reward users for confirming their E-Mails
  ...
  'mail_signature' => [
    // signature that will be included at the end of every message sent using _mail function
  ...
  'highscores_ids_hidden' => [0], // this ids of players will be hidden on the highscores (should be ids of samples)
  'highscores_length' => 100, // how many records per page on highscores

  // characters page
  'characters' => [
    // what things to display on character view page (true/false in each option)
    'level' => true,
    'experience' => true,
    'magic_level' => true,
    'balance' => true,
