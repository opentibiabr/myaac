...
class Parsedown
{
  ...
  protected function blockListContinue($Line, array $Block)
  {
    ...
    if (
      ...
      ($Block['data']['type'] === 'ol' and
        preg_match('/^[0-9]++' . $Block['data']['markerTypeRegex'] . '(?:[ ]++(.*)|$)/', $Line['text'], $matches) or
        $Block['data']['type'] === 'ul' and preg_match('/^' . $Block['data']['markerTypeRegex'] . '(?:[ ]++(.*)|$)/', $Line['text'], $matches))
    ) {
      if (isset($Block['interrupted'])) {
  ...
  protected function blockTable($Line, array $Block = null)
  {
    ...
    if (
      strpos($Block['element']['handler']['argument'], '|') === false and
        strpos($Line['text'], '|') === false and
        strpos($Line['text'], ':') === false or
  ...
  protected function inlineUrl($Excerpt)
  {
    ...
    if (
      strpos($Excerpt['context'], 'http') !== false and
