...
if (!empty($errors)) {
  ...
  $twig->display('guilds.back_button.html.twig', ['action' => '?subtopic=guilds&action=show&guild=' . $guild_name]);
} else {
  if (isset($_REQUEST['todo']) && $_REQUEST['todo'] == 'save') {
    ...
    $twig->display('success.html.twig', [
      ...
      'custom_buttons' => $twig->render('guilds.back_button.html.twig', ['action' => '?subtopic=guilds&action=show&guild=' . $guild_name]),
    ]);
  } else {
    $twig->display('guilds.delete_invite.html.twig', [
