      ...
      if ($account->isLoaded()) {
        if ($account->getCustomField('email_next') < time()) {
          echo 'Please enter e-mail to account with this character.<br><br>
                ...
                <tr><td bgcolor="' .
            $config['vdarkborder'] .
            '" class="white"><b>Please enter e-mail to account</b></td></tr>
                <tr><td bgcolor="' .
            $config['darkborder'] .
            '">
                <span style="margin-right: 55px">Character:</span><input type=text name="nick" value="' .
            $nick .
            '" size="40" readonly="readonly"><br>
    ...
    if ($account->isLoaded()) {
      ...
      if (!empty($account_key)) {
        echo 'If you enter right recovery key you will see form to set new e-mail and password to account. To this e-mail will be send your new password and account name.<BR>
						...
						<TR><TD BGCOLOR="' .
          $config['vdarkborder'] .
          '" class="white"><B>Please enter your recovery key</B></TD></TR>
						<TR><TD BGCOLOR="' .
          $config['darkborder'] .
          '">
						<span style="margin-right: 3px">Character name:</span><INPUT TYPE=text NAME="nick" VALUE="' .
          $nick .
          '" SIZE="40" readonly="readonly"><BR />
