...
if (Forum::canPost($account_logged)) {
  ...
  if ($section_id = $_REQUEST['section_id'] ?? null) {
    echo '<div class="ForumBreadCrumbs"><a href="' .
      ...
      getForumBoardLink($section_id) .
      '">' .
      $sections[$section_id]['name'] .
      '</a> | <b>Post new thread</b></div><br />';
    if (isset($sections[$section_id]['name']) && Forum::hasAccess($section_id)) {
      ...
      if (isset($_REQUEST['save'])) {
        ...
        if (count($errors) == 0) {
          ...
          $db->query(
            'INSERT INTO `' .
              FORUM_TABLE_PREFIX .
              "forum` (`first_post` ,`last_post` ,`section` ,`replies` ,`views` ,`author_aid` ,`author_guid` ,`post_text` ,`post_topic` ,`post_smile`, `post_html` ,`post_date` ,`last_edit_aid` ,`edit_date`, `post_ip`) VALUES ('0', '" .
              time() .
              "', '" .
              (int) $section_id .
              "', '0', '0', '" .
      ...
      if (!$saved) {
        ...
        $twig->display('forum.new_thread.html.twig', [
