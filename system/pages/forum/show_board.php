...
if(!$logged){
?>
<p class="ForumWelcome">You are <b>not</b> logged in.<br><a href="?account/manage">Log in</a> to post on the forum.</p>
<?php } ?>
<div class="ForumBreadCrumbs"><a href="<?php echo getLink('forum') ?>">Community Boards</a> | <b><?php echo $sections[$section_id]['name'] ?></b></div>
...
<?php if(!$sections[$section_id]['closed'] || Forum::isModerator()){ ?>
	...
	<div class="TableHeaderRightButton"><div class="BigButton" style="background-image:url(<?php echo $template_path ?>/images/global/buttons/sbutton_green.gif)"><div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);"><div class="BigButtonOver" style="background-image: url(<?php echo $template_path ?>/images/global/buttons/sbutton_green_over.gif); visibility: hidden;"></div><input class="BigButtonText" type="submit" value="New Topic"></div></div></div>
	</a>
<?php } ?>
...
<table border="0" cellpadding="2" cellspacing="0" width="100%"><tbody><tr><td></td>
	<td>
		<div style="float: right;">
<?php if(!$sections[$section_id]['closed'] || Forum::isModerator()){ ?>
	<a href="?subtopic=forum&action=new_thread&section_id=<?php echo $section_id ?>"><div class="BigButton" style="background-image:url(<?php echo $template_path ?>/images/global/buttons/sbutton_green.gif)"><div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);"><div class="BigButtonOver" style="background-image: url(<?php echo $template_path ?>/images/global/buttons/sbutton_green_over.gif); visibility: hidden;"></div><input class="BigButtonText" type="submit" value="New Topic"></div></div></a>
<?php } ?>
		</div>
	</td>
</tr></tbody></table>
