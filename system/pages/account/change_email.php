  ...
  if (isset($_POST['changeemailsave']) && $_POST['changeemailsave'] == 1) {
    ...
    if (empty($errors)) {
      ...
      $twig->display('success.html.twig', [
        ...
        'description' =>
          'You have requested to change your email address to <b>' .
          $email_new .
          '</b>. The actual change will take place after <b>' .
          date('j F Y, G:i:s', $email_new_time) .
          '</b>, during which you can cancel the request at any time.',
      ]);
    } else {
      //show errors
      ...
      //show form
      $twig->display('account.change_mail.html.twig', [
...
<table width="100%">
	<tr>
		...
		<td align=left>
			<form action="' .
        getLink('account/email') .
        '" method="post"><input type="hidden" name="changeemailsave" value=1 >
				<INPUT TYPE=image NAME="I Agree" SRC="' .
        $template_path .
        '/images/global/buttons/sbutton_iagree.gif" BORDER=0 WIDTH=120 HEIGHT=17>
			</form>
		</td>
		<td align=left>
			<form action="' .
  ...
  } elseif (!isset($_POST['emailchangecancel']) || $_POST['emailchangecancel'] != 1) {
    $custom_buttons =
      '
<table style="width:100%;" >
    ...
    $twig->display('success.html.twig', [
      ...
      'description' =>
        ...
        $email_new .
        '</b>.<br/>The actual change will take place on <b>' .
        date('j F Y, G:i:s', $email_new_time) .
        '</b>.<br>If you do not want to change your email address, please click on "Cancel".',
      'custom_buttons' => $custom_buttons,
    ]);
  }
}
if (isset($_POST['emailchangecancel']) && $_POST['emailchangecancel'] == 1) {
  ...
  $custom_buttons =
    '<div style="text-align:center"><table border="0" cellspacing="0" cellpadding="0" ><form action="?subtopic=accountmanagement" method="post" ><tr><td style="border:0px;" >' .
    $twig->render('buttons.back.html.twig') .
