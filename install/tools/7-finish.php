...
$locale['step_finish_desc'] = str_replace('$LINK$', generateLink('https://docs.opentibiabr.com/projects/myaac', 'https://docs.opentibiabr.com/projects/myaac', true), $locale['step_finish_desc']);
