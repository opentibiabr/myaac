if (!window.__twttrlr) {
  (function (a, b) {
    ...
    function A(a, b) {
      (this.id = a),
        (this.body = b),
        typeof b == 'undefined' && (this.path = this.resolvePath(a));
    }
    function B(a, b) {
      (this.deps = a),
        (this.collectResults = b),
    ...
    function E(a, b) {
      ...
      return (
        !a && c && (d = k || D()),
        d
          ? (delete l[d.scriptId], (d.body = b), d.execute())
          : ((j = d = new A(a, b)), (i[d.id] = d)),
        d
      );
    }
    function F() {
      var a = t(arguments),
        ...
        c;
      return (
        typeof a[0] == 'string' && (b = a.shift()), (c = a.shift()), E(b, c)
      );
    }
    function G(a, b) {
      var c = b.id || '',
      ...
      return (
        ...
        E(c, function (a) {
          function f() {
            var e = H(t(b), c),
              f;
            typeof d == 'function' ? (f = d.apply(c, e)) : (f = d),
              typeof f == 'undefined' && (f = c.exports),
              a(f);
          }
          var c = this,
            e = [];
    ...
    function J() {
      ...
      typeof a[a.length - 1] == 'function' && (b = a.pop()),
        typeof a[a.length - 1] == 'boolean' && (c = a.pop());
      var d = new B(K(a, c), c);
      return b && d.then(b), d;
    }
    function K(a, b) {
    ...
    function N() {
      return (
        (a.using = m), (a.provide = n), (a.define = o), (a.loadrunner = p), M
      );
    }
    function O(a) {
      for (var b = 0; b < J.bundles.length; b++)
        for (var c in J.bundles[b])
          if (c != a && v(J.bundles[b][c], a) > -1) return c;
    }
    ...
    (y.prototype.then = function (b) {
      var c = this;
      return (
        this.started || ((this.started = !0), this.start()),
        this.completed
          ? b.apply(a, this.results)
          : ((this.callbacks = this.callbacks || []), this.callbacks.push(b)),
        this
      );
    }),
      ...
      (z.prototype.start = function () {
        ...
        return (d = i[this.id])
          ...
          : ((b = h[this.id])
              ...
              : !this.force && v(z.loaded, this.id) > -1
                ? this.loaded()
                : (c = O(this.id))
                  ? J(c, function () {
                      a.loaded();
        ...
        (this.scriptId = c.id = 'LR' + ++e),
          ...
          (c.onreadystatechange = c.onload =
            function (c) {
              ...
              if (
                c.type == 'load' ||
                v(['loaded', 'complete'], this.readyState) > -1
              )
                (this.onreadystatechange = null), b.loaded();
            }),
          (c.src = this.path),
          (k = this),
          d[0].parentNode.insertBefore(c, d[0]),
          (k = null),
          (l[c.id] = this);
      }),
      ...
      (z.prototype.complete = function () {
        v(z.loaded, this.id) == -1 && z.loaded.push(this.id),
          delete h[this.id],
          y.prototype.complete.apply(this, arguments);
      }),
      (A.exports = {}),
      (A.prototype = new z()),
          ...
          for (var c = 0, d; (d = a.deps[c]); c++) {
            ...
            d.results.length > 0 &&
              (a.collectResults
                ? d instanceof C
                  ? s(b[0], d.results[0])
                  : x(b[0], d.id, d.results[0])
                : (b = b.concat(d.results)));
          }
    ...
    (M.Script = z),
      ...
      (J.path = ''),
      (J.matchers = []),
      (J.matchers.add = function (a, b) {
        this.unshift([a, b]);
      }),
      J.matchers.add(/(^script!|\.js$)/, function (a) {
        var b = new z(
          a
            .replace(/^\$/, J.path.replace(/\/$/, '') + '/')
            .replace(/^script!/, ''),
          !1,
        );
        return (b.id = a), b;
      ...
      f &&
        ((J.path =
          ...
          f.src.split(/loadrunner\.js/)[0] ||
          ''),
        (main = f.getAttribute('data-main')) &&
          J.apply(a, main.split(/\s*,\s*/)).then(function () {}));
  })(this, document);
...
__twttrlr(function (using, provide, loadrunner, define) {
  provide('util/util', function (a) {
    function b(a) {
      var b = 1,
        ...
        d;
      for (; (c = arguments[b]); b++)
        for (d in c) if (!c.hasOwnProperty || c.hasOwnProperty(d)) a[d] = c[d];
      return a;
    }
    function c(a) {
      for (var b in a)
        a.hasOwnProperty(b) &&
          (k(a[b]) && (c(a[b]), l(a[b]) && delete a[b]),
          (a[b] === undefined || a[b] === null || a[b] === '') && delete a[b]);
      return a;
    }
    function d(a, b) {
      var c = 0,
  ...
  provide('tfw/util/globals', function (a) {
    function c() {
      var a = document.getElementsByTagName('meta'),
        ...
        e = 0;
      for (; (c = a[e]); e++) {
        if (!/^twitter:/.test(c.name)) continue;
    ...
    using('util/querystring', 'util/util', 'util/twitter', function (b, c, d) {
      ...
      function f() {
        var a = document.getElementsByTagName('link'),
          b = 0,
          c;
        for (; (c = a[b]); b++) if (c.rel == 'canonical') return e(c.href);
      }
      function g() {
        ...
        for (; (e = c[g]); g++)
          for (h = 0; (f = e[h]); h++)
            if (i.test(f.rel) && (j = d.screenName(f.href))) return j;
      }
  ...
  provide('util/iframe', function (a) {
    a(function (a) {
      var b = (
          (a.replace && a.replace.ownerDocument) ||
          document
        ).createElement('div'),
        c,
        d,
      ...
      if (a.css)
        for (d in a.css) a.css.hasOwnProperty(d) && (c.style[d] = a.css[d]);
      if (a.attributes)
        for (e in a.attributes)
          a.attributes.hasOwnProperty(e) && c.setAttribute(e, a.attributes[e]);
      return (
        a.replace
          ? a.replace.parentNode.replaceChild(c, a.replace)
          : a.insertTarget && a.insertTarget.appendChild(c),
        c
      );
    });
  });
    ...
    using('util/util', function (b) {
      function c(a, c, d, e) {
        ...
        if (b.isNative(c.getElementsByClassName))
          return (
            (h = b.filter(c.getElementsByClassName(a), function (a) {
      ...
      function e(a, c, d) {
        ...
        return f.tagName == a
          ? f
          : ((g = f.className.split(' ')),
            0 === a.indexOf('.') && ~b.indexOf(g, a.slice(1)) ? f : e(a, f, d));
      }
  ...
  provide('util/domready', function (a) {
    ...
    /^loade|c/.test(document.readyState) && (b = 1),
      document[i] &&
        document[i](
          h,
          (e = function () {
    ...
    using(
      ...
      function (b, c, d, e, f, g) {
        function m(a) {
          ...
          if (!a) return;
          a.ownerDocument
            ? ((this.srcEl = a), (this.classAttr = a.className.split(' ')))
            : ((this.srcOb = a), (this.classAttr = [])),
            (b = this.params()),
            (this.id = o()),
            this.setLanguage(),
            (this.related = b.related || this.dataAttr('related')),
            (this.partner = b.partner || this.dataAttr('partner')),
            (this.dnt = b.dnt || this.dataAttr('dnt') || ''),
            (this.styleAttr = []),
            (this.targetEl = a.targetEl);
        }
        function n() {
          var a = 0,
            b;
          ...
          l = {
            ar: {
              '%{followers_count} followers':
                'Ø¹Ø¯Ø¯ Ø§Ù„Ù…ØªØ§Ø¨Ø¹ÙŠÙ† %{followers_count}',
              '100K+': '+100 Ø£Ù„Ù',
            ...
            fa: {
              '%{followers_count} followers':
                '%{followers_count} Ø¯Ù†Ø¨Ø§Ù„â€ŒÚ©Ù†Ù†Ø¯Ù‡',
              '100K+': '>Û±Û°Û°Ù‡Ø²Ø§Ø±',
            ...
            hi: {
              '%{followers_count} followers':
                '%{followers_count} à¤«à¤¼à¥‰à¤²à¥‹à¤…à¤°à¥à¤¸',
              '100K+': '1 à¤²à¤¾à¤–+',
              '10k unit': '10 à¤¹à¤œà¤¾à¤° à¤‡à¤•à¤¾à¤ˆà¤¯à¤¾à¤‚',
              Follow: 'à¤«à¤¼à¥‰à¤²à¥‹',
              'Follow %{screen_name}':
                '%{screen_name} à¤•à¥‹ à¤«à¤¼à¥‰à¤²à¥‹ à¤•à¤°à¥‡à¤‚',
              K: 'à¤¹à¤œà¤¾à¤°',
              M: 'à¤®à¤¿à¤²à¤¿à¤¯à¤¨',
              Tweet: 'à¤Ÿà¥à¤µà¥€à¤Ÿ',
            ...
            ja: {
              '%{followers_count} followers':
                '%{followers_count}äººã®ãƒ•ã‚©ãƒ­ãƒ¯ãƒ¼',
              '100K+': '100Kä»¥ä¸Š',
              '10k unit': 'ä¸‡',
            ...
            ko: {
              '%{followers_count} followers':
                '%{followers_count}ëª…ì˜ íŒ”ë¡œì›Œ',
              '100K+': '100ë§Œ ì´ìƒ',
              '10k unit': 'ë§Œ ë‹¨ìœ„',
              Follow: 'íŒ”ë¡œìš°',
              'Follow %{screen_name}': '%{screen_name} íŒ”ë¡œìš°í•˜ê¸°',
              K: 'ì²œ',
              M: 'ë°±ë§Œ',
              Tweet: 'íŠ¸ìœ—',
            ...
            pl: {
              '%{followers_count} followers':
                '%{followers_count} obserwujÄ…cych',
              '100K+': '100 tys.+',
              '10k unit': '10 tys.',
              Follow: 'Obserwuj',
            ...
            ru: {
              '%{followers_count} followers':
                'Ð§Ð¸Ñ‚Ð°Ñ‚ÐµÐ»Ð¸: %{followers_count} ',
              '100K+': '100 Ñ‚Ñ‹Ñ.+',
            ...
            th: {
              '%{followers_count} followers':
                '%{followers_count} à¸œà¸¹à¹‰à¸•à¸´à¸”à¸•à¸²à¸¡',
              '100K+': '100à¸žà¸±à¸™+',
        ...
        b.aug(m.prototype, {
          setLanguage: function (a) {
            ...
            a ||
              (a =
                this.params().lang || this.dataAttr('lang') || p(this.srcEl)),
              (a = a && a.toLowerCase());
            if (!a) return (this.lang = 'en');
            if (l[a]) return (this.lang = a);
            b = a.replace(/[\-_].*/, '');
            if (l[b]) return (this.lang = b);
            this.lang = 'en';
          },
          _: function (a, b) {
            var c = this.lang;
            b = b || {};
            if (!c || !l.hasOwnProperty(c)) c = this.lang = 'en';
            return (
              (a = (l[c] && l[c][a]) || a), this.ringo(a, b, /%\{([\w_]+)\}/g)
            );
          },
          ringo: function (a, b, c) {
            return (
              (c = c || /\{\{([\w_]+)\}\}/g),
              a.replace(c, function (a, c) {
          ...
          styles: {
            base: [
              [
                'font',
                "normal normal normal 11px/18px 'Helvetica Neue', Arial, sans-serif",
              ],
              ['margin', '0'],
              ['padding', '0'],
              ['whiteSpace', 'nowrap'],
          ...
          dimensions: function () {
            ...
            this.minWidth() && (c['min-width'] = this.minWidth()),
              this.maxWidth() && (c['max-width'] = this.maxWidth()),
              this.minHeight() && (c['min-height'] = this.minHeight()),
              this.maxHeight() && (c['max-height'] = this.maxHeight());
            for (b in c) c[b] = a(c[b]);
            return c;
          },
          generateId: o,
        }),
          (m.afterLoad = function (a) {
            k.push(a);
          }),
          (m.init = function (a) {
            i = a;
            ...
            for (; (e = a[f]); f++)
              for (k in b)
                if (b.hasOwnProperty(k)) {
                  k.match(/\./)
                    ? ((l = k.split('.')), (c = d.all(l[1], e, l[0])))
                    : (c = e.getElementsByTagName(k));
                  for (m = 0; (o = c[m]); m++) {
                    if (o.getAttribute('data-twttr-rendered')) continue;
                    o.setAttribute('data-twttr-rendered', 'true'),
                      (h = new b[k](o)),
                      j.list.push(h),
                      (j.byId[h.id] = h),
                      h.render(i);
    ...
    using(
      ...
      function (b, c, d, e) {
        function m(a) {
          ...
          j > i && (c = Math.round(j / 2 - i / 2)),
            window.open(
              a,
              undefined,
              [g, 'width=' + h, 'height=' + i, 'left=' + b, 'top=' + c].join(
                ',',
              ),
            );
        }
        ...
        function p(a) {
          ...
          if (a.altKey || a.metaKey || a.shiftKey) return;
          while (b) {
            if (~c.indexOf(['A', 'AREA'], b.nodeName)) break;
            b = b.parentNode;
          }
          b &&
            b.href &&
  ...
  provide('dom/classname', function (a) {
    function b(a, b) {
      a.classList
        ? a.classList.add(b)
        : f(b).test(a.className) || (a.className += ' ' + b);
    }
    function c(a, b) {
      a.classList
        ? a.classList.remove(b)
        : (a.className = a.className.replace(f(b), ' '));
    }
    function d(a, d, g) {
      a.classList && e(a, d)
        ? (c(a, d), b(a, g))
        : (a.className = a.className.replace(f(d), g));
    }
    function e(a, b) {
      ...
      function (b, c, d, e) {
        ...
        function p() {
          ...
          return (
            ...
            a.webkitTransition !== undefined ||
            a.mozTransition !== undefined ||
            a.oTransition !== undefined ||
            a.msTransition !== undefined
          );
        }
        var f = window.navigator.userAgent,
          ...
          h = !1,
          i = 'twitter-csp-test';
        (twttr.verifyCSP = function (a) {
          var b = document.getElementById(i);
          (h = !0), (g = !!a), b && b.parentNode.removeChild(b);
        }),
          b(function () {
            var a;
            if (l() || m()) return (g = !1);
            if (c.asBoolean(e.val('widgets:csp'))) return (g = !0);
            (a = document.createElement('script')),
              (a.id = i),
              (a.text = 'twttr.verifyCSP(false);'),
  ...
  provide('util/css', function (a) {
    using('util/util', function (b) {
      a({
        sanitize: function (a, c, d) {
          var e = /^[\w ,%\/"'\-_#]+$/,
            f =
              a &&
              b.map(a.split(';'), function (a) {
    ...
    using('util/params', function (b) {
      function d() {
        ...
        return c !== undefined
          ? c
          : ((c = !1),
            d && /^\d+$/.test(d) && (c = +new Date() - parseInt(d) < a),
            c);
      }
      var c;
      a({ isDynamicWidget: d });
    ...
    using('dom/cookie', function (b) {
      a(function (a) {
        ...
        return (
          ...
          (a = d.test(a) && d.exec(a)[1]),
          b('dnt')
            ? !0
            : c.test(document.location.host)
              ? !0
              : a && c.test(a)
                ? !0
                : document.navigator
    ...
    using('util/domready', 'util/env', function (b, c) {
      ...
      function f(a, b, c, d) {
        ...
        (this.attrs = b || {}),
          ...
          (this.onReady = a),
          (this.sandbox = {}),
          (f = e(this.attrs, this.styles)),
          (f.onreadystatechange = f.onload = this.getCallback(this.onLoad)),
          (this.sandbox.frame = f),
          d ? d(f) : document.body.appendChild(f);
      }
      function g(a, c, d, e) {
        b(function () {
          new f(a, c, d, e);
      ...
      window.twttr || (window.twttr = {}),
        ...
        (f.prototype.getCallback = function (a) {
          var b = this,
            c = !1;
          return function () {
            c || ((c = !0), a.call(b));
        ...
        (f.prototype.onLoad = function () {
          ...
          (this.sandbox.win = this.sandbox.frame.contentWindow),
            (this.sandbox.doc = this.sandbox.frame.contentWindow.document),
            this.writeStandardsDoc(),
            (this.sandbox.body =
              this.sandbox.frame.contentWindow.document.body),
            this.onReady(this.sandbox);
        }),
        (f.prototype.setDocDomain = function () {
          var a,
            b = this.registerCallback(this.getCallback(this.onLoad));
          (a = [
            'javascript:',
            'document.write("");',
            ...
            '}',
            'window.parent.twttr.sandbox["' + b + '"]();',
          ].join('')),
            this.sandbox.frame.parentNode.removeChild(this.sandbox.frame),
            (this.sandbox.frame = null),
            (this.sandbox.frame = e(this.attrs, this.styles)),
            (this.sandbox.frame.src = a),
            this.appender
              ? this.appender(this.sandbox.frame)
              : document.body.appendChild(this.sandbox.frame);
        }),
        (f.prototype.writeStandardsDoc = function () {
          if (!c.anyIE() || c.cspEnabled()) return;
          var a = [
            '<!DOCTYPE html>',
            '<html>',
            '<head>',
      ...
      function (b, c, d, e, f, g) {
          ...
          c(
            function (a) {
              (r = a.frame),
                ...
                (l = E()),
                (m = F());
              while (n[0]) y.apply(this, n.shift());
              o && z();
            },
            { id: 'rufous-sandbox' },
            { display: 'none' },
        ...
        function v(a, c, h, j) {
          ...
          (a = a || {}),
            (j = !!j),
            (h = !!h),
            (m = a.original_redirect_referrer || document.referrer),
            (j = j || d(m)),
            (l = g.aug({}, a)),
            h ||
              (w(l, 'referrer', m),
              w(l, 'widget', +f.isDynamicWidget()),
              w(l, 'hask', +!!b('k')),
              w(l, 'li', +!!b('twid')),
              w(l, n, b(n) || '')),
            j && (w(l, 'dnt', 1), H(l)),
        ...
        function x(a, b, c) {
          ...
          (f = g.aug({}, b, { event_namespace: a })),
            c
              ? ((i += D({ l: I(f) })), G(i))
              : ((d = l.firstChild),
                (d.value = +d.value || +f.dnt),
                (h = I(f)),
        ...
        function C(a, b, c) {
          var e = { _category_: 'tfw_client_event' },
            f,
            h;
          return (
            (b = !!b),
            (c = !!c),
            (f = g.aug(e, a || {})),
            (h = f.widget_origin || document.referrer),
            (f.format_version = 1),
            (f.dnt = c = c || d(h)),
            (f.triggered_on = f.triggered_on || +new Date()),
            b || (f.widget_origin = h),
            c && H(f),
            f
          );
        ...
        function E() {
          var a = q.createElement('form'),
            b = q.createElement('input');
          return (
            k++,
            (a.action = s),
            (a.method = 'POST'),
            (a.target = 'rufous-frame-' + k),
            (a.id = 'rufous-form-' + k),
            (b.type = 'hidden'),
            (b.name = 'dnt'),
            (b.value = 0),
        ...
        function H(a) {
          var b;
          for (b in a) ~g.indexOf(j, b) && delete a[b];
        }
        function I(a) {
    ...
    using('util/logger', 'util/util', 'util/querystring', function (b, c, d) {
      ...
      function m(a) {
        return function (c) {
          c.error
            ? a.error && a.error(c)
            : c.headers && c.headers.status != 200
              ? (a.error && a.error(c), b.warn(c.headers.message))
      ...
      function n(a) {
        ...
        b &&
          ...
          (b = undefined)),
          a.callbackName &&
            twttr.tfw.callbacks[a.callbackName] &&
            delete twttr.tfw.callbacks[a.callbackName];
      }
      function o(a) {
        var b = {};
        return (
          a.success && l('function', a.success) && (b.success = a.success),
          a.error && l('function', a.error) && (b.error = a.error),
          a.complete && l('function', a.complete) && (b.complete = a.complete),
          b
        );
      }
      function p(a, b, c) {
        ...
        return function (g) {
          ...
          if (++f === d) {
            ...
            b.error && k.length > 0 && b.error(k),
              b.success && j.length > 0 && b.success(j),
              b.complete && b.complete(i);
          }
        };
      }
      (twttr = twttr || {}),
      ...
      twttr.widgets &&
        twttr.widgets.endpoints &&
        c.aug(k, twttr.widgets.endpoints),
        (j.jsonp = function (a, b, c) {
          var j = c || g + h,
            k = e + '.' + j,
            l = document.createElement('script'),
            n = { callback: k, suppress_response_codes: !0 };
          f[j] = m(b);
        ...
        (j.user = function () {
          var a,
            ...
            f;
          arguments.length === 1
            ? ((a = arguments[0].screenName), (b = o(arguments[0])))
            : ((a = arguments[0]), (b.success = arguments[1])),
            (c = l('array', a) ? k.userLookup : k.userShow),
            (a = l('array', a) ? a.join(',') : a),
            (e = { screen_name: a }),
            (f = d.url(c, e)),
            this.jsonp(f, b);
        }),
        (j.userById = function (a) {
          ...
          arguments.length === 1
            ? ((b = a.ids), (c = o(a)))
            : ((b = a), (c.success = arguments[1])),
            (e = l('array', b) ? k.userLookup : k.userShow),
            (b = l('array', b) ? b.join(',') : b),
            (f = { user_id: b }),
            (g = d.url(e, f)),
            this.jsonp(g, c);
        }),
        (j.status = function () {
          var a,
            ...
            g;
          arguments.length === 1
            ? ((a = arguments[0].id), (b = o(arguments[0])))
            : ((a = arguments[0]), (b.success = arguments[1]));
          if (!l('array', a))
            (c = { id: a, include_entities: !0 }),
              (e = d.url(k.status, c)),
              this.jsonp(e, b);
          else {
            f = p(a, b, function (a) {
              return a.error
                ? a.request.split('id=')[1].split('&')[0]
                : a.id_str;
            });
            for (g = 0; g < a.length; g++)
              (c = { id: a[g], include_entities: !0 }),
                (e = d.url(k.status, c)),
                this.jsonp(e, { success: f, error: f });
          }
        }),
        (j.tweets = function (a) {
          var b = arguments[0],
            c = o(b),
            e = { ids: a.ids.join(','), lang: a.lang },
            f = d.url(k.tweets, e);
          this.jsonp(f, c);
        }),
        (j.count = function () {
          var a = '',
            ...
            e = {};
          arguments.length === 1
            ? ((a = arguments[0].url), (e = o(arguments[0])))
            : arguments.length === 2 &&
              ((a = arguments[0]), (e.success = arguments[1])),
            (c = { url: a }),
            (b = d.url(k.count, c)),
            this.jsonp(b, e);
        }),
        (j.friendshipExists = function (a) {
          var b = o(a),
            c = { screen_name_a: a.screenNameA, screen_name_b: a.screenNameB },
            e = d.url(k.friendship, c);
          this.jsonp(e, b);
        }),
        (j.timeline = function (a) {
          var b = arguments[0],
            ...
            f,
            g = 9e5,
            h = Math.floor(+new Date() / g),
            i = {
              lang: a.lang,
              t: h,
              domain: window.location.host,
              dnt: a.dnt,
              override_type: a.overrideType,
              override_id: a.overrideId,
              override_name: a.overrideName,
              override_owner_id: a.overrideOwnerId,
              override_owner_name: a.overrideOwnerName,
              with_replies: a.withReplies,
            };
          c.compact(i),
            (f = d.url(k.timeline + a.id, i)),
            this.jsonp(f, e, 'tl_' + a.id + '_' + a.instanceId);
        }),
  ...
  provide('util/datetime', function (a) {
    using('util/util', function (b) {
              ...
              : g < i
                ? ((m = Math.floor(g / h)),
                  e(d.abbr, {
                    ...
                    symbol: e(l, {
                      abbr: e('s'),
                      expanded: m > 1 ? e('seconds') : e('second'),
                    }),
                  }))
                : g < j
                  ? ((m = Math.floor(g / i)),
                    e(d.abbr, {
                      ...
                      symbol: e(l, {
                        abbr: e('m'),
                        expanded: m > 1 ? e('minutes') : e('minute'),
                      }),
                    }))
                  : g < k
                    ? ((m = Math.floor(g / j)),
                      e(d.abbr, {
                        ...
                        symbol: e(l, {
                          abbr: e('h'),
                          expanded: m > 1 ? e('hours') : e('hour'),
                        }),
                      }))
                    : g < k * 365
                      ? e(d.shortdate, {
                          day: b.getDate(),
                          month: e(c[b.getMonth()]),
                        })
                      : e(d.longdate, {
                          day: b.getDate(),
                          month: e(c[b.getMonth()]),
                          year: b.getFullYear().toString().slice(2),
                        })
            : '';
        }),
          (this.localTimeStamp = function (a) {
            ...
            return b
              ? e(d.full, {
                  ...
                  year: b.getFullYear(),
                  hours24: m(f),
                  hours12: f < 13 ? (f ? f : '12') : f - 12,
                  minutes: m(b.getMinutes()),
                  seconds: m(b.getSeconds()),
                  amPm: f < 12 ? e('AM') : e('PM'),
                })
              : '';
          });
      ...
      var c =
        ...
        d =
          /[a-z]{3,4} ([a-z]{3}) (\d{1,2}) (\d{1,2}):(\d{2}):(\d{2}) ([\+\-]\d{2}:?\d{2}) (\d{4})/i,
        e = /^\d+$/,
        f = [
          'Jan',
          'Feb',
        ...
        j = i * 60,
        k = j * 24,
        l = '<abbr title="%{expanded}">%{abbr}</abbr>';
      (n.parseDate = function (a) {
        ...
        return (
          (i = (function () {
            var a;
            if (e.test(h)) return parseInt(h, 10);
            if ((a = h.match(d)))
  ...
  provide('tfw/util/assets', function (a) {
    using('util/env', function (b) {
      ...
      var c = {
        'embed/timeline.css': {
          default:
            'embed/timeline.97ea650dd75d8c1ac0e2c6b4918203b5.default.css',
          '2x': 'embed/timeline.97ea650dd75d8c1ac0e2c6b4918203b5.2x.css',
          gif: 'embed/timeline.97ea650dd75d8c1ac0e2c6b4918203b5.gif.css',
          'default.rtl':
            'embed/timeline.97ea650dd75d8c1ac0e2c6b4918203b5.default.rtl.css',
          '2x.rtl':
            'embed/timeline.97ea650dd75d8c1ac0e2c6b4918203b5.2x.rtl.css',
          'gif.rtl':
            'embed/timeline.97ea650dd75d8c1ac0e2c6b4918203b5.gif.rtl.css',
        },
      };
      a(d);
    });
  ...
  provide('tfw/widget/syndicatedbase', function (a) {
    using(
      ...
      'util/twitter',
      'util/util',
      function (b, c, d, e, f, g, h, i, j, k) {
        function s() {
          (p = v.VALID_COLOR.test(e.val('widgets:link-color')) && RegExp.$1),
            (r =
              v.VALID_COLOR.test(e.val('widgets:border-color')) && RegExp.$1),
            (q = e.val('widgets:theme'));
        }
        function t(a, b, c) {
          var d;
          c = c || document;
        ...
        function v(a) {
          ...
          (this.sandboxReadyCallbacks = []),
            ...
            (this.targetEl =
              ...
              c.targetEl ||
              document.body),
            (this.containerWidth = this.targetEl && this.targetEl.offsetWidth),
            (d =
              c.width ||
              this.attr('width') ||
              this.containerWidth ||
            ...
            (this.height =
              v.VALID_UNIT.test(c.height || this.attr('height')) && RegExp.$1),
            (this.width = Math.max(
            ...
            (this.narrow =
              c.narrow || this.width <= this.dimensions.NARROW_WIDTH),
            this.narrow && this.classAttr.push('var-narrow'),
            v.VALID_COLOR.test(c.linkColor || this.dataAttr('link-color'))
              ? (this.linkColor = RegExp.$1)
              : (this.linkColor = p),
            v.VALID_COLOR.test(c.borderColor || this.dataAttr('border-color'))
              ? (this.borderColor = RegExp.$1)
              : (this.borderColor = r),
            (this.theme = c.theme || this.attr('data-theme') || q),
            (this.theme = /(dark|light)/.test(this.theme) ? this.theme : ''),
            this.classAttr.push(i.touch() ? 'is-touch' : 'not-touch'),
            h(
              function (a) {
              ...
              function (a) {
                e.srcEl
                  ? e.targetEl.insertBefore(a, e.srcEl)
                  : e.targetEl.appendChild(a);
              },
            );
        }
        var l = [
        ...
        (v.prototype = new b()),
          k.aug(v.prototype, {
            setupSandbox: function (a) {
              ...
              (this.sandbox = a),
                ...
                (a.win.onresize = function () {
                  g.handleResize && g.handleResize();
                }),
                (this.frameIsReady = !0);
              for (; (h = this.sandboxReadyCallbacks.shift()); )
                h.fn.apply(h.context, h.args);
            },
            ...
            callIfSandboxReady: function (a, b, c) {
              (c = c || []),
                b.frameIsReady
                  ? a.apply(b, [!1].concat(c))
                  : b.sandboxReadyCallbacks.push({
                      fn: a,
                      context: b,
                      args: [!0].concat(c),
                    });
              ...
              var a = this.dimensions,
                b =
                  this.chromeless && this.narrow
                    ? a.NARROW_MEDIA_PADDING_CL
                    : this.chromeless
                      ? a.WIDE_MEDIA_PADDING_CL
                      : this.narrow
                        ? a.NARROW_MEDIA_PADDING
                        : a.WIDE_MEDIA_PADDING;
              return this.width - b;
            },
            addSiteStyles: function () {
              var a = this,
                ...
                f = [];
              if (i.cspEnabled()) return;
              if (b.getElementById(c)) return;
              this.headingStyle &&
                f.push(k.map(o, e).join(',') + '{' + this.headingStyle + '}'),
                this.linkColor &&
                  (f.push(
                    k.map(l, e).join(',') + '{color:' + this.linkColor + '}',
                  ),
                  f.push(
                    k.map(m, e).join(',') +
                      '{background-color:' +
              ...
              (d = b.createElement('style')),
                ...
                (d.type = 'text/css'),
                d.styleSheet
                  ? (d.styleSheet.cssText = f.join(''))
                  : d.appendChild(b.createTextNode(f.join(''))),
            ...
            bindIntentHandlers: function () {
              ...
              g.delegate(b, 'click', '.profile', function (b) {
                ...
                if (b.altKey || b.metaKey || b.shiftKey) return;
          ...
          (v.VALID_UNIT = /^([0-9]+)( ?px)?$/),
          (v.VALID_COLOR = /^(#(?:[0-9a-f]{3}|[0-9a-f]{6}))$/i),
          (v.retinize = function (a) {
            if (!i.retina()) return;
          ...
          (v.scaleDimensions = function (a, b, c, d) {
            return (
              b > a && b > d
                ? ((a *= d / b), (b = d))
                : a > c &&
                  ((b *= c / a), (a = c), b > d && ((a *= d / b), (b = d))),
              { width: Math.ceil(a), height: Math.ceil(b) }
            );
          }),
          (v.constrainMedia = function (a, b) {
            ...
            for (; (e = [c, d][i]); i++)
              if (e.length)
                for (j = 0; (f = e[j]); j++)
                  (g = v.scaleDimensions(
                    f.getAttribute('width') || f.width,
                    f.getAttribute('height') || f.height,
                    b,
                    375,
                  )),
                    g.width > 0 && (f.width = g.width),
                    g.height > 0 && (f.height = g.height),
  ...
  provide('tfw/widget/timeline', function (a) {
    using(
      ...
      'dom/classname',
      'dom/get',
      function (b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
        function M(a) {
          if (!a) return;
          var c, d, e, f, g, i, j;
          (this.a11yTitle = this._('Twitter Timeline Widget')),
            b.apply(this, [a]),
            (c = this.params()),
            (d = (c.chrome || this.dataAttr('chrome') || '').split(' ')),
            (this.preview = c.previewParams),
            (this.widgetId = c.widgetId || this.dataAttr('widget-id')),
            (this.instanceId = ++L),
            (f = c.screenName || this.dataAttr('screen-name')) ||
            (g = c.userId || this.dataAttr('user-id'))
              ? (this.override = {
                  overrideType: 'user',
                  overrideId: g,
                  overrideName: f,
                  withReplies: o.asBoolean(
                    c.showReplies || this.dataAttr('show-replies'),
                  )
                    ? 'true'
                    : 'false',
                })
              : (f =
                    c.favoritesScreenName ||
                    this.dataAttr('favorites-screen-name')) ||
                  (g = c.favoritesUserId || this.dataAttr('favorites-user-id'))
                ? (this.override = {
                ...
                : ((f =
                      c.listOwnerScreenName ||
                      this.dataAttr('list-owner-screen-name')) ||
                      (g = c.listOwnerId || this.dataAttr('list-owner-id'))) &&
                    ((i = c.listId || this.dataAttr('list-id')) ||
                      (j = c.listSlug || this.dataAttr('list-slug')))
                  ? (this.override = {
                      overrideType: 'list',
                      overrideOwnerId: g,
                      overrideOwnerName: f,
                  ...
                  : (this.override = {}),
            (this.tweetLimit = o.asInt(
              c.tweetLimit || this.dataAttr('tweet-limit'),
            )),
            (this.staticTimeline = this.tweetLimit > 0),
            d.length &&
              ((e = ~p.indexOf(d, 'none')),
              (this.chromeless = e || ~p.indexOf(d, 'transparent')),
              (this.headerless = e || ~p.indexOf(d, 'noheader')),
              (this.footerless = e || ~p.indexOf(d, 'nofooter')),
              (this.borderless = e || ~p.indexOf(d, 'noborders')),
              (this.noscrollbar = ~p.indexOf(d, 'noscrollbar'))),
            (this.headingStyle = h.sanitize(
              c.headingStyle || this.dataAttr('heading-style'),
              undefined,
              !0,
            )),
            this.classAttr.push('twitter-timeline-rendered'),
            (this.ariaPolite = c.ariaPolite || this.dataAttr('aria-polite'));
        }
        function N(a, c) {
          var d = a.ownerDocument,
            e = s.one(D, a, 'DIV'),
            f = e && e.children[0],
            g = f && f.getAttribute('data-expanded-media'),
            h,
            i = 0,
            j = s.one(E, a, 'A'),
            k = j && j.getElementsByTagName('B')[0],
            l = k && (k.innerText || k.textContent),
            m;
          if (!k) return;
          (k.innerHTML = j.getAttribute('data-toggled-text')),
            j.setAttribute('data-toggled-text', l);
          if (r.present(a, C)) {
            r.remove(a, C);
            if (!e) return;
          ...
          g &&
            ...
            (h.innerHTML = g),
            b.retinize(h),
            (i = b.constrainMedia(h, c)),
            f.appendChild(h)),
            e &&
              ((m = Math.max(f.offsetHeight, i)),
              (e.style.cssText = 'height:' + m + 'px')),
            r.add(a, C);
        }
        var t = '1.0',
          u = { CLIENT_SIDE_USER: 0, CLIENT_SIDE_APP: 2 },
          v = 'timeline',
          w = 'new-tweets-bar',
          x = 'timeline-header',
          y = 'timeline-footer',
        ...
        (M.prototype = new b()),
          p.aug(M.prototype, {
            ...
            create: function (a) {
              var c = this.sandbox.doc.createElement('div'),
                d,
                e = this,
                g,
                h,
              ...
              if (!d) return;
              this.reconfigure(a.config),
                this.discardStaticOverflow(d),
                this.augmentWidgets(d),
                b.retinize(d),
                b.constrainMedia(d, this.contentWidth()),
                (this.searchQuery = d.getAttribute('data-search-query')),
                (this.profileId = d.getAttribute('data-profile-id')),
                (k = this.getTweetDetails(c));
              for (l in k) k.hasOwnProperty(l) && j.push(l);
              return (
                f.enqueue(
                  {
                    page: 'timeline',
                    component: 'timeline',
                    element: 'initial',
                    action: j.length ? 'results' : 'no_results',
                  },
                  {
                ...
                this.ariaPolite == 'assertive' &&
                  ((h = s.one(w, d, 'DIV')),
                  h.setAttribute('aria-polite', 'assertive')),
                (d.id = this.id),
                (d.className += ' ' + this.classAttr.join(' ')),
                (d.lang = this.lang),
                twttr.widgets.load(d),
                (i = function () {
                  e.sandbox.body.appendChild(d),
                    e.staticTimeline
                      ? e.sandbox.win.setTimeout(function () {
                      ...
                      : e.sandbox.win.setTimeout(function () {
                          var a = s.one(x, d, 'DIV'),
                            ...
                            c = s.one(z, d, 'DIV');
                          b
                            ? (g = a.offsetHeight + b.offsetHeight)
                            : (g = a.offsetHeight),
                            (c.style.cssText =
                              'height:' + (e.height - g - 2) + 'px'),
                            e.noscrollbar && e.hideStreamScrollBar();
                        }, 500),
                    (e.sandbox.frame.style.cssText = ''),
                    (e.sandbox.frame.width = e.width),
                    (e.sandbox.frame.height = e.height),
                    (e.sandbox.frame.style.border = 'none'),
                    (e.sandbox.frame.style.maxWidth = '100%'),
                    (e.sandbox.frame.style.minWidth =
                      e.dimensions.MIN_WIDTH + 'px');
                }),
                this.callsWhenSandboxReady(i)(),
                this.srcEl &&
            ...
            render: function (a, b) {
                    ...
                    p.aug(
                      {
                        ...
                        success: function (a) {
                          (c.element = c.create(a)),
                            ...
                            c.bindInteractions(),
                            a.headers.xPolling &&
                              /\d/.test(a.headers.xPolling) &&
                              (c.pollInterval = a.headers.xPolling * 1e3),
                            c.updateTimeStamps(),
                            c.staticTimeline || c.schedulePolling(),
                            b && b(c.sandbox.frame);
                          return;
                        },
                        error: function (a) {
              ...
              (g = this.preview ? h : i),
                this.sandboxReady ? g() : window.setTimeout(g, 0);
            },
            reconfigure: function (a) {
              (this.lang = a.lang),
                this.theme || (this.theme = a.theme),
                ...
                this.addSiteStyles(),
                !this.height &&
                  b.VALID_UNIT.test(a.height) &&
                  (this.height = RegExp.$1),
                (this.height = Math.max(
                  this.dimensions.MIN_HEIGHT,
                  this.height ? this.height : this.dimensions.DEFAULT_HEIGHT,
                )),
            ...
            getTweetDetails: function (a) {
              var b = s.all(B, a, 'LI'),
                ...
                f,
                g,
                h = { TWEET: 0, RETWEET: 10 },
                i = 0;
              for (; (d = b[i]); i++)
                (e = s.one(F, d, 'A')),
                  (f = m.status(e.href)),
                  (g = d.getAttribute('data-tweet-id')),
                  f === g
                    ? (c[f] = { item_type: h.TWEET })
                    : (c[f] = {
                        item_type: h.RETWEET,
                        target_type: h.TWEET,
                        target_id: g,
            ...
            bindInteractions: function () {
              ...
              q.delegate(b, 'click', '.' + E, function (c) {
                if (c.altKey || c.metaKey || c.shiftKey) return;
                N(s.ancestor('.' + B, this, b), a.contentWidth()), q.stop(c);
              }),
                q.delegate(b, 'click', 'A', function (a) {
                  q.stopPropagation(a);
                }),
                q.delegate(b, 'click', '.with-expansion', function (b) {
                  N(this, a.contentWidth()), q.stop(b);
                }),
            ...
            update: function () {
              var a = this,
                b = s.one(B, this.element, 'LI'),
                c = b && b.getAttribute('data-tweet-id');
              this.updateTimeStamps(),
                this.requestTweets(c, !0, function (b) {
                  b.childNodes.length > 0 && a.insertNewTweets(b);
                });
            },
            loadMore: function () {
              var a = this,
                b = s.all(B, this.element, 'LI').pop(),
                c = b && b.getAttribute('data-tweet-id');
              this.requestTweets(c, !1, function (b) {
                var d = s.one(H, a.element, 'P'),
                  e = b.childNodes[0];
                (d.style.cssText = ''),
                  e && e.getAttribute('data-tweet-id') == c && b.removeChild(e);
            ...
            forceLoad: function () {
              var a = this,
                b = !!s.all(A, this.element, 'OL').length;
              this.requestTweets(1, !0, function (c) {
                c.childNodes.length &&
                  (a[b ? 'insertNewTweets' : 'appendTweets'](c),
                  r.add(a.element, 'has-tweets'));
              });
            },
            schedulePolling: function (a) {
              var b = this;
              if (this.pollInterval === null) return;
              (a = twttr.widgets.poll || a || this.pollInterval || 1e4),
                a > -1 &&
                  window.setTimeout(function () {
            ...
            requestTweets: function (a, c, d) {
              ...
              (h[c ? 'sinceId' : 'maxId'] = a),
                ...
                (h.success = function (a) {
                  var e = g.sandbox.doc.createDocumentFragment(),
                    h = g.sandbox.doc.createElement('div'),
                    i = [],
                    j,
                    k;
                  a &&
                    ...
                    a.headers.xPolling &&
                    /\d+/.test(a.headers.xPolling) &&
                    (g.pollInterval = a.headers.xPolling * 1e3);
                  if (a && a.body !== undefined) {
                    h.innerHTML = a.body;
                    if (h.children[0] && h.children[0].tagName != 'LI') return;
                    ...
                    i.length &&
                      (f.enqueue(
                        {
                          page: 'timeline',
                          component: 'timeline',
                          element: c ? 'newer' : 'older',
                          action: 'results',
                        },
                        {
                          widget_id: g.widgetId,
                          widget_origin: document.location.href,
                          item_ids: i,
                          item_details: j,
                          client_version: t,
                      ...
                      f.flush()),
                      b.retinize(h),
                      b.constrainMedia(h, g.contentWidth());
                    while (h.children[0]) e.appendChild(h.children[0]);
                    d(e);
                  }
                }),
            ...
            insertNewTweets: function (a) {
              ...
              r.remove(this.element, I),
                (e.style.cssText = 'margin-top: -' + g + 'px'),
                window.setTimeout(function () {
                  (c.scrollTop = 0),
                    r.add(b.element, I),
                    i.cssTransitions()
            ...
            appendTweets: function (a) {
              var b = s.one(z, this.element, 'DIV'),
                c = s.one(A, b, 'OL');
              this.updateTimeStamps(), c.appendChild(a);
            },
            gcTweets: function (a) {
              var b = s.one(A, this.element, 'OL'),
                c = b.children.length,
                d;
              a = a || 50;
            ...
            showNewTweetNotifier: function () {
              var a = this,
                b = s.one(w, this.element, 'DIV'),
                c = b.children[0];
              (b.style.cssText = ''),
                r.add(this.element, J),
                b.removeChild(c),
                b.appendChild(c),
                r.replace(this.element, J, K),
            ...
            augmentWidgets: function (a) {
              var b = s.all(G, a, 'A'),
                ...
                d;
              for (; (d = b[c]); c++)
                d.setAttribute('data-related', this.related),
                  d.setAttribute('data-partner', this.partner),
                  d.setAttribute('data-dnt', this.dnt),
                  d.setAttribute('data-search-query', this.searchQuery),
                  d.setAttribute('data-profile-id', this.profileId),
                  this.width < 250 &&
                    d.setAttribute('data-show-screen-name', 'false');
            },
            discardStaticOverflow: function (a) {
              ...
              if (this.staticTimeline) {
                this.height = 0;
                while ((c = b.children[this.tweetLimit])) b.removeChild(c);
              }
            },
            hideStreamScrollBar: function () {
              var a = s.one(z, this.element, 'DIV'),
                b = s.one(A, this.element, 'OL'),
                c;
              (a.style.width = ''),
                (c = this.element.offsetWidth - b.offsetWidth),
                c > 0 && (a.style.width = this.element.offsetWidth + c + 'px');
            },
            ...
            updateTimeStamps: function () {
              var a = s.all(F, this.element, 'A'),
                ...
                f;
              for (; (b = a[d]); d++) {
                (e = b.getAttribute('data-datetime')),
                  (f = e && this.datetime.timeAgo(e, this.i18n)),
            ...
            addUrlParams: function (a) {
              ...
              return (
                (this.addUrlParams = g(c, function (a) {
            ...
            showNSFW: function (a) {
              ...
              if (!c) return;
              (e = b.scaleDimensions(
                c.getAttribute('data-width'),
                c.getAttribute('data-height'),
                this.contentWidth(),
                c.getAttribute('data-height'),
              )),
                (d = !!(h = c.getAttribute('data-player'))),
                d
                  ? (j = this.sandbox.doc.createElement('iframe'))
                  : ((j = this.sandbox.doc.createElement('img')),
                    (h = c.getAttribute(
                      i.retina() ? 'data-image-2x' : 'data-image',
                    )),
                    (j.alt = c.getAttribute('data-alt')),
                    (k = this.sandbox.doc.createElement('a')),
                    (k.href = c.getAttribute('data-href')),
                    k.appendChild(j)),
                (j.title = c.getAttribute('data-title')),
                (j.src = h),
                (j.width = e.width),
                (j.height = e.height),
                (g = s.ancestor('.' + D, c, a)),
                (f = e.height - c.offsetHeight),
                c.parentNode.replaceChild(d ? j : k, c),
                (g.style.cssText = 'height:' + (g.offsetHeight + f) + 'px');
            },
              ...
              (this.handleResize = l(
                function () {
                  var a = Math.min(
                    ...
                    Math.max(
                      this.dimensions.MIN_WIDTH,
                      this.sandbox.frame.offsetWidth,
                    ),
                  );
                  if (!this.element) return;
                  a < this.dimensions.NARROW_WIDTH
                    ? ((this.narrow = !0), r.add(this.element, 'var-narrow'))
                    : ((this.narrow = !1),
                      r.remove(this.element, 'var-narrow')),
                    this.noscrollbar && this.hideStreamScrollBar();
                },
                50,
                this,
              )),
  ...
  provide('tfw/widget/embed', function (a) {
    using(
      ...
      function (b, c, d, e, f, g, h, i, j, k, l, m) {
        function q(a, b, c) {
          var d = g.one('subject', a, 'BLOCKQUOTE'),
            e = g.one('reply', a, 'BLOCKQUOTE'),
            f = d && d.getAttribute('data-tweet-id'),
            h = e && e.getAttribute('data-tweet-id'),
            i = {},
            j = {};
          if (!f) return;
          (i[f] = { item_type: 0 }),
          ...
          (j[h] = { item_type: 0 }),
            m.enqueue(
              ...
              },
              {
                ...
                item_ids: [h],
                item_details: j,
                associations: { 4: { association_id: f, association_type: 4 } },
              },
              !0,
              c,
            );
        ...
        function t(a) {
          if (!a) return;
          var b, d, e;
          (this.a11yTitle = this._('Embedded Tweet')),
            c.apply(this, [a]),
            (b = this.params()),
            (d = this.srcEl && this.srcEl.getElementsByTagName('A')),
            (e = d && d[d.length - 1]),
            (this.hideThread =
              (b.conversation || this.dataAttr('conversation')) == 'none' ||
              ~i.indexOf(this.classAttr, 'tw-hide-thread')),
            (this.hideCard =
              (b.cards || this.dataAttr('cards')) == 'hidden' ||
              ~i.indexOf(this.classAttr, 'tw-hide-media'));
          if (
            (b.align || this.attr('align')) == 'left' ||
            ~i.indexOf(this.classAttr, 'tw-align-left')
          )
            this.align = 'left';
          else if (
            (b.align || this.attr('align')) == 'right' ||
            ~i.indexOf(this.classAttr, 'tw-align-right')
          )
            this.align = 'right';
          else if (
            (b.align || this.attr('align')) == 'center' ||
            ~i.indexOf(this.classAttr, 'tw-align-center')
          )
            (this.align = 'center'),
              this.containerWidth > this.dimensions.MIN_WIDTH * (1 / 0.7) &&
                this.width > this.containerWidth * 0.7 &&
                (this.width = this.containerWidth * 0.7);
          (this.narrow =
            b.narrow || this.width <= this.dimensions.NARROW_WIDTH),
            this.narrow && this.classAttr.push('var-narrow'),
            (this.tweetId = b.tweetId || (e && k.status(e.href)));
        }
        var n = '2.0',
          o = 'tweetembed',
          p = {};
        (t.prototype = new c()),
          i.aug(t.prototype, {
            ...
            create: function (a) {
              ...
              return (
                ...
                this.augmentWidgets(d),
                c.retinize(d),
                c.constrainMedia(d, this.contentWidth()),
                (d.id = this.id),
                (d.className += ' ' + this.classAttr.join(' ')),
                (d.lang = this.lang),
                twttr.widgets.load(d),
                this.sandbox.body.appendChild(d),
                (f.cssText = ''),
                (e.width = this.width),
                (e.height = 0),
                (f.display = 'block'),
                (f.border = 'none'),
                (f.maxWidth = '99%'),
                (f.minWidth = this.dimensions.MIN_WIDTH + 'px'),
                (f.padding = '0'),
                q(d, this.partner, this.dnt),
                d
              );
            },
            render: function (a, b) {
              ...
              this.hideCard && (d += 'c'),
                this.hideThread && (d += 't'),
                d && (e += '-' + d),
                (h = this.callsWhenSandboxReady(function (a) {
                  function d() {
                    var a = c.sandbox.frame,
                      b = a.style;
                    c.srcEl &&
                      c.srcEl.parentNode &&
                      c.srcEl.parentNode.removeChild(c.srcEl),
                      (b.borderRadius = '5px'),
                      (b.margin = '10px 0'),
                      (b.border = '#ddd 1px solid'),
                      (b.borderTopColor = '#eee'),
                      (b.borderBottomColor = '#bbb'),
                      (b.boxShadow = '0 1px 3px rgba(0,0,0,0.15)'),
                      c.align == 'center'
                        ? ((b.margin = '7px auto'), (b.float = 'none'))
                        : c.align &&
                          (c.width == c.dimensions.DEFAULT_WIDTH &&
                            (a.width = c.dimensions.NARROW_WIDTH),
                          (b.float = c.align)),
                      c.handleResize();
                  }
                  var b;
                  if (
                    (!window.getComputedStyle ||
                      c.sandbox.win.getComputedStyle(c.sandbox.body, null)
                        .display !== 'none') &&
                  ...
                  b = window.setInterval(function () {
                    (!window.getComputedStyle ||
                      c.sandbox.win.getComputedStyle(c.sandbox.body, null)
                        .display !== 'none') &&
                      c.element.offsetHeight &&
                      (window.clearInterval(b), d());
                  }, 100);
                })),
                (f = this.callsWhenSandboxReady(function (a, d) {
                  (c.element = c.create(d)),
                    c.readTimestampTranslations(),
                    c.updateTimeStamps(),
                    c.bindIntentHandlers(),
                    b && b(c.sandbox.frame);
                })),
            ...
            augmentWidgets: function (a) {
              var b = g.all('twitter-follow-button', a, 'A'),
                c,
                d = 0;
              for (; (c = b[d]); d++)
                c.setAttribute('data-related', this.related),
                  c.setAttribute('data-partner', this.partner),
                  c.setAttribute('data-dnt', this.dnt),
                  c.setAttribute('data-show-screen-name', 'false');
            },
            addUrlParams: function (a) {
              var b = this,
                c = { related: this.related, partner: this.partner, tw_p: o };
              return (
                (this.addUrlParams = e(c, function (a) {
            ...
            handleResize: function () {
              (this.handleResize = j(
                function () {
                  ...
                  if (!this.element) return;
                  b < this.dimensions.NARROW_WIDTH
                    ? ((this.narrow = !0), f.add(this.element, 'var-narrow'))
                    : ((this.narrow = !1),
                      f.remove(this.element, 'var-narrow')),
                    window.setTimeout(function () {
                      a.sandbox.frame.height = a.height =
            ...
            readTimestampTranslations: function () {
              var a = this.element,
                b = 'data-dt-',
                c = a.getAttribute(b + 'months') || '';
              this.datetime = new d(
                i.compact({
                  phrases: {
                    AM: a.getAttribute(b + 'am'),
                    PM: a.getAttribute(b + 'pm'),
                  },
                  months: c.split('|'),
                  formats: { full: a.getAttribute(b + 'full') },
                }),
              );
            },
            updateTimeStamps: function () {
              var a = g.one('long-permalink', this.element, 'A'),
                b = a.getAttribute('data-datetime'),
                c = b && this.datetime.localTimeStamp(b),
                d = a.getElementsByTagName('TIME')[0];
              if (!c) return;
              if (d && d.innerHTML) {
                d.innerHTML = c;
                return;
          ...
          (t.fetchAndRender = function () {
            ...
            p = {};
            if (a.keys) b = a.keys();
            else for (c in a) a.hasOwnProperty(c) && b.push(c);
            if (!b.length) return;
            m.initPostLogging(),
              (d = a[b[0]][0].lang),
              l.tweets({
  ...
  provide('dom/textsize', function (a) {
    function c(a, b, c) {
      var d = [],
        e = 0,
        f;
      for (; (f = c[e]); e++) d.push(f[0]), d.push(f[1]);
      return a + b + d.join(':');
    }
    function d(a) {
      var b = a || '';
    ...
    a(function (a, e, f) {
      ...
      try {
        for (; (j = f[k]); k++) g.style[j[0]] = j[1];
      } catch (n) {
        for (; (j = f[l]); l++) m.push(d(j[0]) + ':' + j[1]);
        g.setAttribute('style', m.join(';') + ';');
      }
      return (
        (g.innerHTML = a),
        document.body.appendChild(g),
        (h.width = g.clientWidth || g.offsetWidth),
        (h.height = g.clientHeight || g.offsetHeight),
    ...
    using(
      ...
      function (b, c, d, e, f) {
        function i(a) {
          ...
          c.apply(this, [a]),
            (b = this.params()),
            (this.text = b.text || this.dataAttr('text')),
            this.text &&
              /\+/.test(this.text) &&
              !/ /.test(this.text) &&
              (this.text = this.text.replace(/\+/g, ' ')),
            (this.align = b.align || this.dataAttr('align') || ''),
            (this.via = b.via || this.dataAttr('via')),
            (this.placeid = b.placeid || this.dataAttr('placeid')),
            (this.hashtags = b.hashtags || this.dataAttr('hashtags')),
            (this.screen_name = e.screenName(
              b.screen_name ||
                b.screenName ||
                this.dataAttr('button-screen-name'),
            )),
            (this.url = b.url || this.dataAttr('url'));
        }
    ...
    using(
      ...
      function (b, c, d, e, f, g) {
        var h = document.title,
          i = encodeURI(location.href),
          j = ['vertical', 'horizontal', 'none'],
          k = function (a) {
            b.apply(this, [a]);
            var d = this.params(),
              g = d.count || this.dataAttr('count'),
              k = d.size || this.dataAttr('size'),
              l = e.getScreenNameFromPage();
            if (
              d.type == 'hashtag' ||
              ~c.indexOf(this.classAttr, 'twitter-hashtag-button')
            )
              this.type = 'hashtag';
            else if (
              d.type == 'mention' ||
              ~c.indexOf(this.classAttr, 'twitter-mention-button')
            )
              this.type = 'mention';
            (this.counturl = d.counturl || this.dataAttr('counturl')),
              (this.searchlink = d.searchlink || this.dataAttr('searchlink')),
              (this.button_hashtag = f.hashTag(
                d.button_hashtag ||
                  d.hashtag ||
                  this.dataAttr('button-hashtag'),
                !1,
              )),
              (this.size = k == 'large' ? 'l' : 'm'),
              this.type
                ? ((this.count = 'none'),
                  l &&
                    (this.related = this.related ? l + ',' + this.related : l))
                : ((this.text = this.text || h),
                  (this.url = this.url || e.getCanonicalURL() || i),
                  (this.count = ~c.indexOf(j, g) ? g : 'horizontal'),
                  (this.count =
                    this.count == 'vertical' && this.size == 'l'
                      ? 'none'
                      : this.count),
                  (this.via = this.via || l));
          };
        (k.prototype = new b()),
          c.aug(k.prototype, {
            ...
            width: function () {
              var a = { ver: 8, cnt: 14, btn: 24, xlcnt: 18, xlbtn: 38 },
                b = this.count == 'vertical',
                d =
                  this.type == 'hashtag' && this.button_hashtag
                    ? 'Tweet %{hashtag}'
                    : this.type == 'mention' && this.screen_name
                      ? 'Tweet to %{name}'
                      : 'Tweet',
                e = this._(d, {
                ...
                o = n;
              return (
                ~c.indexOf(['ja', 'ko'], this.lang)
                  ? (i += this._('10k unit'))
                  : (i = i.length > h.length ? i : h),
                b
                  ? ((o = n.concat(this.styles.vbubble)),
                    (m = a.ver),
                    (l = a.btn))
                  : this.size == 'l'
                    ? ((n = o = n.concat(this.styles.large)),
                      (l = a.xlbtn),
                      (m = a.xlcnt))
                    : ((l = a.btn), (m = a.cnt)),
                this.count != 'none' && (k = g(i, '', o).width + m),
                (j = g(e, '', n.concat(this.styles.button)).width + l),
                b ? (j > k ? j : k) : (this.calculatedWidth = j + k)
              );
            },
            render: function (a, b) {
              var c =
                twttr.widgets.config.assetUrl() +
                '/widgets/tweet_button.1372833608.html#' +
                this.parameters();
              this.count && this.classAttr.push('twitter-count-' + this.count),
                (this.element = this.create(c, this.dimensions(), {
    ...
    using(
      ...
      function (b, c, d, e, f, g) {
        function h(a) {
          ...
          c.apply(this, [a]),
            (b = this.params()),
            (d = b.size || this.dataAttr('size')),
            (e = b.showScreenName || this.dataAttr('show-screen-name')),
            (h = b.count || this.dataAttr('count')),
            this.classAttr.push('twitter-follow-button'),
            (this.showScreenName = e != 'false'),
            (this.showCount =
              b.showCount !== !1 && this.dataAttr('show-count') != 'false'),
            h == 'none' && (this.showCount = !1),
            (this.explicitWidth = b.width || this.dataAttr('width') || ''),
            (this.screenName =
              b.screen_name || b.screenName || f.screenName(this.attr('href'))),
            (this.preview = b.preview || this.dataAttr('preview') || ''),
            (this.align = b.align || this.dataAttr('align') || ''),
            (this.size = d == 'large' ? 'l' : 'm');
        }
        (h.prototype = new c()),
          b.aug(h.prototype, {
            parameters: function () {
            ...
            render: function (a, b) {
              ...
              var c =
                twttr.widgets.config.assetUrl() +
                '/widgets/follow_button.1372833608.html#' +
                this.parameters();
              (this.element = this.create(c, this.dimensions(), {
            ...
            width: function () {
              ...
              var a = { cnt: 13, btn: 24, xlcnt: 22, xlbtn: 38 },
                c = this.showScreenName ? 'Follow %{screen_name}' : 'Follow',
                d = this._(c, { screen_name: '@' + this.screenName }),
                e = ~b.indexOf(['ja', 'ko'], this.lang)
                  ? this._('10k unit')
                  : this._('M'),
              ...
              return (
                this.size == 'l'
                  ? ((l = l.concat(this.styles.large)),
                    (j = a.xlbtn),
                    (k = a.xlcnt))
                  : ((j = a.btn), (k = a.cnt)),
                this.showCount && (i = g(f, '', l).width + k),
                (h = g(d, '', l.concat(this.styles.button)).width + j),
                (this.calculatedWidth = h + i)
              );
            },
          }),
          a(h);
  ...
  !(function () {
    function a(a) {
      return (a || !/^http\:$/.test(window.location.protocol)) &&
        !twttr.ignoreSSL
        ? 'https'
        : 'http';
    }
    ...
    (twttr.init = !0),
      ...
      using.path.length || (using.path = a() + '://' + twttr.host + '/js'),
          ...
          using(
            ...
            function (c, d, e, f, g, h, i, j, k) {
              function q(b) {
                var c = twttr.host;
                return (
                  a(b) == 'https' && twttr.secureHost && (c = twttr.secureHost),
                  a(b) + '://' + c
                );
              }
              function r() {
              ...
              var l,
                ...
                n = {
                  widgets: {
                    'a.twitter-share-button': e,
                    'a.twitter-mention-button': e,
                    'a.twitter-hashtag-button': e,
                    'a.twitter-follow-button': d,
                    'blockquote.twitter-tweet': f,
                    'a.twitter-timeline': g,
                    body: h,
                  },
                },
                o = twttr.events && twttr.events.hub ? twttr.events : {},
                p;
              i.init(),
                (n.assetUrl = q),
                ...
                k.aug(twttr.widgets, {
                  ...
                  createFollowButton: function (a, b, c, e) {
                    if (!a || !b) return c && c(!1);
                    (e = k.aug({}, e || {}, { screenName: a, targetEl: b })),
                      new d(e).render(n, c);
                  },
                  createTweet: function (a, b, c, d) {
                    if (!a || !b) return c && c(!1);
                    (d = k.aug({}, d || {}, { tweetId: a, targetEl: b })),
                      new f(d).render(n, c),
                      f.fetchAndRender();
                  },
                  createTimeline: function (a, b, c, d) {
                    if (!a || !b) return c && c(!1);
                    (d = k.aug({}, d || {}, { widgetId: a, targetEl: b })),
                      new g(d).render(n, c);
                  },
                }),
                k.aug(twttr.events, o, j.Emitter),
                (p = twttr.events.bind),
                (twttr.events.bind = function (a, b) {
              ...
              (twttr.ready = function (a) {
                ...
                /twitter\.com(\:\d+)?$/.test(document.location.host) &&
                  (twttr.widgets.createTimelinePreview = function (a, b, c) {
                    if (!n || !b) return c && c(!1);
                    new g({
                      previewParams: a,
                      targetEl: b,
