...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL; ?>admin/bootstrap/bootstrap-lucasg.css"> <!-- CUSTOM -->
...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu" data-widget="tree">
                <li class="header">MyAAC <?= MYAAC_VERSION ?></li>
                ...
                foreach ($menus as $_name => $_page) {
                    ...
                    if (!$has_child) {
                        ...
                        echo ">";
                        echo '<a href="?p=' . $_page . '"><i class="fa fa-' . ($icons_a[$i] ?? 'link') . '"></i> <span>' . $_name . '</span></a></li>';
                    }
                    ...
                    if ($has_child) {
                        ...
                        echo '<li class="treeview' . (($used_menu) ? ' menu-open' : '') . '">
                                      <a href="#"><i class="fa fa-' . ($icons_a[$i] ?? 'link') . '"></i> <span>' . $_name . '</span>
    ...
    <footer class="main-footer">
        ...
        Powered by MyAAC and edited by OpenTibiaBR.
    </footer>
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        <label class="control-sidebar-subheading">
                            <?= MYAAC_VERSION ?> (<a href="?p=version">Check for updates</a>)<br/>
                        </label>
                        <label class="control-sidebar-subheading">
