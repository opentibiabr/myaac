...
<div class="row">
    <div class="col-3">
        <div class="box">
            ...
            <div class="box-body">
                <div class="box-body">
                    <button type="button" class="btn btn-myaac" data-bs-toggle="modal" data-bs-target="#resetposModal">
                        <i class="fa-solid fa-map-location-dot"></i> Reset Position
                    </button>
                    <button type="button" class="btn btn-myaac" data-bs-toggle="modal" data-bs-target="#resettownModal">
    ...
    <div class="col-3">
        <div class="box">
            ...
            <div class="box-body">
                <div class="box-body">
                    <button type="button" class="btn btn-myaac" data-bs-toggle="modal" data-bs-target="#resetpremModal">
...
<div class="modal fade" id="resettownModal" tabindex="-1" aria-labelledby="resettownModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="resettownModalLabel"><i class="fa-solid fa-earth-americas"></i> Reset Town
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
            </div>
...
<div class="modal fade" id="resetcoinsModal" tabindex="-1" aria-labelledby="resetcoinsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="resetcoinsModalLabel"><i class="fa-solid fa-sack-dollar"></i> Reset Tibia
                    Coins</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
            </div>
