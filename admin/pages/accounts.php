...
if (isset($_REQUEST['id'])) {
  $id = (int) $_REQUEST['id'];
} elseif ($searchName = $_REQUEST['search_name'] ?? null) {
...
} elseif (isset($_REQUEST['search_account'])) {
  $search_account = $_REQUEST['search_account'];
} elseif ($id > 0 && isset($account) && $account->isLoaded()) {
  if (USE_ACCOUNT_NAME) {
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <select name="web_flags" id="web_flags" class="form-control">
                                <?php
                                $web_acc = ['None', 'Admin', 'Super Admin', '(Admin + Super Admin)'];
                    ...
                    <table class="table table-striped">
                        ...
                        foreach ($query as $p) {
                          ...
                          echo '<tr>
                            ...
                            $p['name'] .
                            '"><span class="btn btn-success btn-sm edit"><i class="fa fa-edit"></i></span></a></span></td>
                        </tr>';
                          $i++;
                        }
                        ?>
