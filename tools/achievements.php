...
$achievements = [
    ...
    '131' => [
        ...
        'points' => '4',
        'secret' => false,
        'description' => 'Yu\'re a beggar, homeless, wearing filthy and ragged clothes. But that doesn\'t mean you have to beg anyone for stuff - and you still kept your pride. Fine feathers do not necessarily make fine birds - what\'s under them is more important.'
    ],
    '132' => [
        'name' => 'Make a Wish',
        'grade' => '1',
    ...
    '431' => [
        ...
        'points' => '3',
        'secret' => false,
        'description' => 'Though you couldn\'t prevent the theft of the godbreaker knowledge, you still managed to fight of the invasion of the library and to kill the scourge of oblivion, a powerful servant of the enemy.'
    ],
    '432' => [
        'name' => 'Lizard Kingdom',
        'grade' => '1',
        'points' => '1',
        'secret' => false,
        'description' => 'From the southern steppe through the Dragonblaze Mountains and the Muggy Plains to the forbidden city of Razzachai - you really know every corner of Zao now.'
    ],
    '433' => [
    ...
    '473' => [
        ...
        'points' => '1',
        'secret' => true,
        'description' => 'You made acquaintance with the Thaian. A strange contemporary with a dark history. No man but a derivate of green and obsession.'
    ],
    '474' => [
